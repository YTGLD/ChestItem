...
public abstract class AdvancementWidgetMixin implements IAdvancementWidget {
    ...
    @Override
    public void CI$draw(GuiGraphics guiGraphics, int x, int y) {
        ...
        for (AdvancementWidget advancementwidget : this.children) {
            if (advancementwidget instanceof IAdvancementWidget advancementWidget) {
                advancementWidget.CI$draw(guiGraphics, x, y);
            }
        }
    ...
    @Override
    public void CI$drawHover(GuiGraphics guiGraphics, int x, int y, float fade, int width, int height) {
        ...
        if (!this.description.isEmpty()) {
            if (flag1) {
                guiGraphics.blitSprite(ResourceLocation.fromNamespaceAndPath(Chestitem.MODID,"advancements/box"), i1, l + 26 - j1, this.width, j1);
            } else {
                guiGraphics.blitSprite(ResourceLocation.fromNamespaceAndPath(Chestitem.MODID,"advancements/box"), i1, l, this.width, j1);
            }
        }
