...
public class CubeEvil extends SingleQuadParticle {
    public CubeEvil(ClientLevel level, double x, double y, double z, float movementX, float movementY, float movementZ, TextureAtlasSprite textureAtlasSprite) {
        ...
        this.scale(Mth.nextFloat(RandomSource.create(),0.2f,0.5f));
        this.gravity = 0.35f;
    }
    ...
    public record Provider(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
        ...
        public @NotNull Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5, RandomSource textureAtlasSprite) {
            CubeEvil particle = new CubeEvil(clientLevel, v,v1,v2, (float) v3, (float) v4, (float) v5,sprite.get(textureAtlasSprite));
