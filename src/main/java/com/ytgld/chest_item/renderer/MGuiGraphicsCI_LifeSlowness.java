...
public class MGuiGraphicsCI_LifeSlowness {
    ...
    private static void blit(GuiGraphics guiGraphics, ResourceLocation texture, float startX, float endX, float startY, float endY, float zLevel, float u0, float u1, float v0, float v1, float r, float g, float b, float a) {
        ...
        RenderSystem.setShader(MRender::getLiveShaderInstance_slowness);
        ...
        bufferbuilder.addVertex(matrix4f, (float) startX, (float) startY, (float) zLevel).setColor(r, g, b, a).setUv(u0, v0).setLight(255);
        bufferbuilder.addVertex(matrix4f, (float) startX, (float) endY, (float) zLevel).setColor(r, g, b, a).setUv(u0, v1).setLight(255);
        bufferbuilder.addVertex(matrix4f, (float) endX, (float) endY, (float) zLevel).setColor(r, g, b, a).setUv(u1, v1).setLight(255);
        bufferbuilder.addVertex(matrix4f, (float) endX, (float) startY, (float) zLevel).setColor(r, g, b, a).setUv(u1, v0).setLight(255);
