...
public class ChaosArmorRender {
    ...
    public static void renderArmorLevel(GuiGraphics graphics, Player player,int rightHeight) {
        if (player != null) {
    ...
    private static void renderChaos(GuiGraphics guiGraphics, Player player, int y, int x) {
        float i = player.getData(AttReg.chaosWinds);
        if (i > 0) {
            if (lastShield != i) {
                glow = 20;
    ...
    private static void drawArmor(int i, int x, GuiGraphics guiGraphics, int yy,
                                  ...
                                  int c,
                                  int d,
                                  int offset, int alpha, Supplier<ShaderInstance> shaderSupplier, boolean isLight
    ){
