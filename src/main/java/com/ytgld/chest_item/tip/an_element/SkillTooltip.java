...
public class SkillTooltip implements ClientTooltipComponent, TooltipComponent {
    ...
    private void renderSlot(Font font,int x, int y, net.minecraft.client.gui.GuiGraphicsExtractor guiGraphics,int i) {
        i --;
        ...
        if (map!=null) {
            ...
            if (number >= elt.levelMax(stack)){
                guiGraphics.centeredText(font, Component.translatable("item.chest_item.skill.level").append(": ")
                                .append(Component.translatable("enchantment.level." + number)
                                        .append(Component.translatable("item.chest_item.skill.level.max"))),
                        x + 56, y + 10, color);
            }else {
                guiGraphics.centeredText(font, Component.translatable("item.chest_item.skill.level").append(": ").append(Component.translatable("enchantment.level." + number)),
                        x + 56, y + 10, color);
            }
            ...
            guiGraphics.centeredText(font, Component.translatable( "item.chest_item.skill.xp").append(": ").append(String.valueOf(sx)), x+56, y+20,color );
        ...
        if (IdentifierMap!=null) {
            ...
            if (Handler.isBlackChaos(stack)) {
                guiGraphics.blit(MRender.RenderPs.GUI_TEXTURED, Identifier.fromNamespaceAndPath(Identifier1.getNamespace(),
        ...
        if (stringMap!=null) {
            ...
            guiGraphics.centeredText(font, component, x+56, y, color);
        }
    }
