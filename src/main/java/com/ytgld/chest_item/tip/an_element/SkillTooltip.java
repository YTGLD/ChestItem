...
public class SkillTooltip implements ClientTooltipComponent, TooltipComponent {
    ...
    private void renderSlot(Font font,int x, int y, GuiGraphics guiGraphics,int i) {
        ...
        if (resourceLocationMap!=null) {
            ...
            guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED,resourceLocation1, x, y, 32, 32);
            if (!(elt instanceof BlackSkill)) {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, ResourceLocation.fromNamespaceAndPath(Chestitem.MODID, "frame"), x, y, 32, 32);
            }else {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, ResourceLocation.fromNamespaceAndPath(Chestitem.MODID, "frame_black"), x, y, 32, 32);
