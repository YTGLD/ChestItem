...
public class MemoryItems {
    ...
    public static final DeferredItem<Item> Bluster_ = register("bluster",
            (resourceLocation)-> new Bluster(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> BlusterTooltip_ = register("bluster_tooltip",
            (resourceLocation)-> new Bluster.BlusterTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;

    public static final DeferredItem<Item> Contradiction_ = register("contradiction",
            (resourceLocation)-> new Contradiction(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> ContradictionTooltip_ = register("contradiction_tooltip",
            (resourceLocation)-> new Contradiction.ContradictionTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;

    public static final DeferredItem<Item> Extreme_ = register("extreme",
            (resourceLocation)-> new Extreme(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> ExtremeTooltip_ = register("extreme_tooltip",
            (resourceLocation)-> new Extreme.ExtremeTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;

    public static final DeferredItem<Item> ForeverCurtain_ = register("forever_curtain",
            (resourceLocation)-> new ForeverCurtain(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> ForeverCurtainTooltip_ = register("forever_curtain_tooltip",
            (resourceLocation)-> new ForeverCurtain.ForeverCurtainTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;



    public static final DeferredItem<Item> Martyrdom_ = register("martyrdom",
            (resourceLocation)-> new Martyrdom(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> MartyrdomTooltip_ = register("martyrdom_tooltip",
            (resourceLocation)-> new Martyrdom.MartyrdomTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;


    public static final DeferredItem<Item> Peace_ = register("peace",
            (resourceLocation)-> new Peace(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> PeaceTooltip_ = register("peace_tooltip",
            (resourceLocation)-> new Peace.PeaceTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;



    public static final DeferredItem<Item> War_ = register("war",
            (resourceLocation)-> new War(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    public static final DeferredItem<Item> WarTooltip_ = register("war_tooltip",
            (resourceLocation)-> new War.WarTooltip(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;



    public static final DeferredItem<Item> TheFox_ = register("the_fox",
            (resourceLocation)-> new TheFox(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
    ...
    public static final DeferredItem<Item>Oblivion_ = register("oblivion",
            (resourceLocation)-> new Oblivion(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM,resourceLocation))));;
