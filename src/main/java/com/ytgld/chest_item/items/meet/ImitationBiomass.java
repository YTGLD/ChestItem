...
public class ImitationBiomass extends ItemBase implements Meat {
    ...
    @Override
     public void text(ItemStack stack,java.util.function.Consumer<Component> tooltipComponents,TooltipFlag flag){
        ...
        tooltipComponents.accept(Component.translatable("item.chest_item.armor_stone.string.1", 100f- ArmorStone.ConfigItem.intValue.get().floatValue()* 100F).withStyle(ChatFormatting.GOLD));
