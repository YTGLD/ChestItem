...
public class ImitationBiomass extends ItemBase implements Meat {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.add(Component.translatable("item.chest_item.armor_stone.string.1").withStyle(ChatFormatting.GOLD));
        tooltipAdder.add(Component.translatable("item.chest_item.stronger_stone.string.1").withStyle(ChatFormatting.GOLD));
        tooltipAdder.add(Component.translatable("item.chest_item.life_stone.string.1").withStyle(ChatFormatting.GOLD));
