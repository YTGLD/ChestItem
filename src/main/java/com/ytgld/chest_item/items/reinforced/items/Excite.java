 ...
 * 腐堕之心的恢复速度会提高%d%%
 */
public class Excite extends EvilMotherReinforced {
    ...
    public void text(ItemStack stack, Consumer<Component> tooltipComponents) {
        ...
        tooltipComponents.accept(Component.translatable("item.chest_item.excite.string.0",ConfigItem.intValue.get() * 100f).withStyle(Style.EMPTY.withColor(color)));
    }
