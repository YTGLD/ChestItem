...
public class ComplexComponents extends MeatBaseItem{
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> attributeUse(Player player) {
        ...
        attributeModifierMultimap.put(AttReg.hyperplasiaCooldown, new AttributeModifier(Identifier.parse(Chestitem.MODID +
    ...
    public void text(ItemStack stack, Consumer<Component> tooltipComponents) {
        ...
        tooltipComponents.accept(Component.translatable("item.chest_item.complex_components.string.0").withStyle(Style.EMPTY.withColor(theColor())));
        tooltipComponents.accept(Component.translatable("item.chest_item.complex_components.string.1",
