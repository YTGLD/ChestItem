...
public class StabilizingDevice extends MeatBaseItem{
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> attributeUse(Player player) {
        ...
        attributeModifierMultimap.put(AttReg.hyperplasia_stronger, new AttributeModifier(ResourceLocation.parse(Chestitem.MODID +
    ...
    public void text(ItemStack stack, List<Component> tooltipComponents) {
        ...
        tooltipComponents.add(Component.translatable("item.chest_item.stabilizing_device.string.0",
                ConfigItem.intValue.get() * 100f).withStyle(Style.EMPTY.withColor(theColor())));
        tooltipComponents.add(Component.translatable("item.chest_item.stabilizing_device.string.1",
