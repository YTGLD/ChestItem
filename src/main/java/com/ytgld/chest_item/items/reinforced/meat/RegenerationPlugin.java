...
public class RegenerationPlugin extends MeatBaseItem{
    ...
    public void text(ItemStack stack, List<Component> tooltipComponents) {
        ...
        tooltipComponents.add(Component.translatable("item.chest_item.regeneration_plugin.string.0",
                ConfigItem.intValue.get() * 100f).withStyle(Style.EMPTY.withColor(theColor())));

        tooltipComponents.add(Component.translatable("item.chest_item.regeneration_plugin.string.1",
