...
public class LifeStone  extends ItemBase implements IGold {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.add(Component.translatable("item.chest_item.life_stone.string.0").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC));
        tooltipAdder.add(Component.literal(""));
        tooltipAdder.add(Component.translatable("item.chest_item.life_stone.string.1", ConfigItem.intValue.get().floatValue()* 100F - 100).withStyle(ChatFormatting.GOLD));
    }
