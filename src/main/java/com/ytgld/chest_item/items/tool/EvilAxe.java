...
public class EvilAxe extends Item implements IEvil {
    public EvilAxe(Properties properties) {
        super(properties.axe(new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL,8000,
                11,
                5,
                30,
                ItemTags.AXES),11,-3.55f));
    }
