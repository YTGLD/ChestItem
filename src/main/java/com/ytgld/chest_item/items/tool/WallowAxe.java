 ...
 * 2倍暴击伤害，非暴击伤害较小
 * */
public class WallowAxe extends Item implements IBlackLight , ITheChaos {
    public WallowAxe(Properties properties) {
        super(properties.axe(new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL,5000,
                9,
                4,
                9,
                        ItemTags.AXES),10,-3.5f));
    }
